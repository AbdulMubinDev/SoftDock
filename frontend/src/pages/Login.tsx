    ...
    >
      ...
      <div className="hidden lg:flex flex-col justify-between w-[45%] p-12 relative border-r border-[var(--border)]">
        ...
        <div>
          ...
          <p className="text-base text-text-muted font-light max-w-[360px] leading-relaxed">
            Paste your error. Get a sourced, working fix. No more tab-hopping through scattered docs and outdated threads.
          </p>
        </div>
            ...
            {(isGoogleLoginEnabled() || isGithubLoginEnabled()) && (
              <>
                <div className="flex items-center gap-3 my-4">
                  ...
                  <span className="text-[12px] text-text-dim uppercase tracking-wider">or continue with</span>
                  <div className="h-px flex-1 bg-[var(--border)]" />
                </div>
